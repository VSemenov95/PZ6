...
public class uni {
    public static void main(String[] args) {
        ...
        for (int j = 0; j < kol; j++) {
            ...
            //массив будет на 1 элемент больше, массива строк для избежания ошибок сравнения с поcледним элементов
            int[] un = new int[kol];
            ...
            for (int k = 1; k < a; k++) {
                ...
                for (int n = 0; n < k; n++) {
                    ...
                    if (sym2 == sym1) {
                        //если текущий символ не равен символу для сравнения, наращиваем счетчик и обновляем его в массиве
